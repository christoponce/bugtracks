...
{
    public partial class ByImportanceForm : Form
    {
        public Issue SelectedIssue;
        private FileIssueService fis;

        public ByImportanceForm(FileIssueService fileIssueService)
        {
            InitializeComponent();
        ...
        private void BTNSearch_Click(object sender, EventArgs e)
        {
            try
            {
                List<Issue> results = fis.GetByImportance((int)UDImportance.Value);
